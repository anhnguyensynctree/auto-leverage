# LLM Prompt Templates — Autoresearch Components

---

## Template 1: Data Preparation (prepare.py)
*Paste this into Claude or ChatGPT when your goal is to improve your training data.*

---

**Goal:** I want to improve the quality or size of the data my language model trains on. Specifically, I want to [describe what you want — e.g., "use more diverse training text", "reduce the amount of data to fit smaller hardware", "change how many words the model sees at once"].
